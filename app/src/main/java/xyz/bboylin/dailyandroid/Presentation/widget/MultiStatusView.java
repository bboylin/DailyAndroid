...
public class MultiStatusView extends RelativeLayout {
    private static final String TAG = "MultiStatusView";
    ...
    public MultiStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultiStatusView, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.MultiStatusView_emptyView, R.layout.empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultiStatusView_errorView, R.layout.error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultiStatusView_loadingView, R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultiStatusView_noNetworkView, R.layout.no_network_view);
        mContentViewResId = a.getResourceId(R.styleable.MultiStatusView_contentView, NULL_RESOURCE_ID);
        a.recycle();
